        ...
        <div class="content">
            <div class="section">
                ...
                <div class="experience-item">
                    <h3>Repetytor Informatyki</h3>
                    <div class="company">Nauczanie indywidualne</div>
                    <div class="date">2020 - obecnie</div>
                    <p>Prowadzenie korepetycji z informatyki dla uczniów liceum, ze szczególnym uwzględnieniem programowania w Python i React. Opracowywanie indywidualnych planów nauki i materiałów dydaktycznych.</p>
                </div>

                <div class="experience-item">
                    <h3>Twórca Stron Internetowych</h3>
                    <div class="company">Projekty własne i zamówienia klientów</div>
                    <div class="date">2021 - obecnie</div>
                    <p>Projektowanie i realizacja nowoczesnych stron internetowych dla osób prywatnych. Tworzenie responsywnych, intuicyjnych interfejsów użytkownika z wykorzystaniem najnowszych technologii webowych.</p>
                </div>
            </div>
        </div>
    </div>,
